...
# e.g. for the HTML content for a home page or for
# the JSON response for a /predict API endpoint, etc.
@app.route("/")
def index():
...
@app.route("/predict")
def predict():
    # let's parse the unseen instance values from the query string
    ...
    return "Error making a prediction"
...
if __name__ == "__main__":
    ...
    # TODO: when deploy app to production, set debug=False and check host + port values
